<form class="navbar-form navbar-right ff-search" data-sid="{$site_sid}" data-limit="{:C('ui_search_limit')}" role="search" action="{$root}index.php?s=vod-search" method="post" data-action="{:ff_url('vod/search',array('wd'=>'FFWD'), true)}" data-action-news="{:ff_url('news/search',array('wd'=>'FFWD'), true)}">
