...
<div class="lunhuan" id="carousel1">
		...
		<div class="slider_mask"></div>
			...
			<div class="le_screen">
				<div class="nav_box nav_box1">
					<h4>按演员</h4>
					<ul>
      <volist name=":explode(',',$list_extend['star'])" id="feifei" offset="0" length="9">
     <li><a href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>'','area'=>'','year'=>'','star'=>urlencode($feifei),'state'=>'','order'=>'addtime','p'=>1),true)}">{$feifei|msubstr=0,4}</a></li>
      </volist>
	  <li><a href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>urlencode($type_type),'area'=>'','year'=>$type_year,'star'=>urlencode($type_star),'state'=>urlencode($type_state),'order'=>'addtime','p'=>1),true)}" >更多</a></li>
				...
				<div class="nav_box nav_box1">
					<h4>按类型</h4>
					<ul>
		<volist name=":explode(',',$list_extend['type'])" id="feifei" offset="0" length="9">
	...
	<li><a href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>'','area'=>urlencode($type_area),'year'=>$type_year,'star'=>urlencode($type_star),'state'=>urlencode($type_state),'order'=>'addtime','p'=>1),true)}">更多</a></li>
				...
				<div class="nav_box nav_box1">
					<h4>按地区</h4>
					<ul>
		<volist name=":explode(',',$list_extend['area'])" id="feifei" offset="0" length="9">
   ...
   <div class="yk-pannel-box"> 
    ...
    <div class="yk-pannel_bd clearfix"> 
     <ul class="index-list-1 active clearfix">
      <volist name=":ff_mysql_vod('cid:'.$list_id.';isend:false;limit:12;order:vod_id;sort:desc')" id="feifei"> 
...
<php>$item_vod=ff_mysql_vod('cid:'.$list_id.';area:'.$feifeilist.';limit:12;cache_name:default;cache_time:default;order:vod_stars desc,vod_addtime;sort:desc');if(!$item_vod){continue;}</php>
<!--{:str_replace(array('国','台湾','大陆','内地','香港','日本'),array('剧','台剧','国产剧','国产剧','港剧','日剧'),$feifeilist)}-->
<div class="yk-pannel clearfix"> 
   <div class="yk-pannel-box"> 
    <div class="yk-pannel_hd"> 
     <div class="yk-pannel_head clearfix"> 
      <a class="more text-muted pull-right" href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>'','area'=>urlencode($feifeilist),'year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}">更多{:str_replace(array('国','台湾','大陆','内地','香港','日本'),array('剧','台剧','国产剧','国产剧','港剧','日剧'),$feifeilist)}</a> 
      <h3 class="title">{:str_replace(array('国','台湾','大陆','内地','香港','日本'),array('剧','台剧','国产剧','国产剧','港剧','日剧'),$feifeilist)}</h3> 
     </div> 
    </div> 
    <div class="yk-pannel_bd clearfix"> 
     <ul class="index-list-1 active clearfix">
