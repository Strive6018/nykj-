		...
		<div class="column">
			<div class="le_screen">
				<div class="nav_box nav_box1">
					<h4>按演员</h4>
					<ul>
      <volist name=":explode(',',$list_extend['star'])" id="feifei" offset="0" length="10">
...
<div class="yk-pannel clearfix"> 
   <div class="yk-pannel-box"> 
    <div class="yk-pannel_hd"> 
     <div class="yk-pannel_head clearfix"> 
      <h3 class="title">高分电影</h3> 
     </div> 
    </div> 
    <div class="yk-pannel_bd clearfix"> 
     <ul class="index-list-1 active clearfix">
      <volist name=":ff_mysql_vod('cid:'.$list_id.';state:正片;limit:12;order:vod_gold desc')" id="feifei"> 
       <include file="Block:yk_img" /> 
      </volist> 
     </ul>
    </div> 
...
<div class="yk-pannel clearfix"> 
   <div class="yk-pannel-box"> 
    <div class="yk-pannel_hd"> 
     <div class="yk-pannel_head clearfix"> 
      <a class="more text-muted pull-right" href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>'','area'=>urlencode($feifeilist),'year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}">更多{:str_replace('片','',$feifeilist)}片</a> 
      <h3 class="title">{:str_replace('片','',$feifeilist)}片</h3> 
     </div> 
    </div> 
    <div class="yk-pannel_bd clearfix"> 
     <ul class="index-list-1 active clearfix">
