...
<section class="select">
		...
		<volist name=":explode(',',$list_extend['type'])" id="feifei" offset="0" length="7">
            <li><a href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>urlencode($feifei),'area'=>'','year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}" title="{$feifei|msubstr=0,4}">{$feifei|msubstr=0,4}片</a></li>
            </volist>
...
<section class="mod aui-margin-t-0">
	<div class="mod-head clearfix">
		<div class="mod-head-title">
			<span class="mod-head-name">高分电影</span>
		</div>
	</div>
	<div class="mod-main clearfix">
		<div class="mod-row">
			<ul class="m-list clearfix" m-list-skin="film">
			<volist name=":ff_mysql_vod('cid:'.$list_id.';state:正片;limit:6;order:vod_gold desc')" id="feifei"> 
<include file="Home:vod_home" />
</volist> 
			</ul>
		</div>
...
<section class="mod aui-margin-t-0">
	<div class="mod-head clearfix">
		<div class="mod-head-title">
			<span class="mod-head-name">{:str_replace('片','',$feifeilist)}片</span>
		</div>
		<a class="change" href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>urlencode($feifeilist),'area'=>'','year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}">更多{:str_replace('片','',$feifeilist)}片</a>
	</div>
	<div class="mod-main clearfix">
		<div class="mod-row">
			<ul class="m-list clearfix" m-list-skin="film">
