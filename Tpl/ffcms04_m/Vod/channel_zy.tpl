...
<section class="select">
		...
		<volist name=":explode(',',$list_extend['type'])" id="feifei" offset="0" length="4">
            <li><a href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>urlencode($feifei),'area'=>'','year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}" title="{$feifei|msubstr=0,4}">{$feifei|msubstr=0,4}综艺</a></li>
            </volist>
		<volist name=":explode(',',$list_extend['area'])" id="feifei" offset="0" length="3">
            <li><a href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>'','area'=>urlencode($feifei),'year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}" title="{$feifei|msubstr=0,4}">{$feifei|msubstr=0,4}综艺</a></li>
            </volist>
...
<!--{:str_replace('片','',$feifeilist)}综艺-->
<section class="mod aui-margin-t-0">
	<div class="mod-head clearfix">
		<div class="mod-head-title">
			<span class="mod-head-name">{:str_replace('片','',$feifeilist)}综艺</span>
		</div>
		<a class="change" href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>'','area'=>urlencode($feifeilist),'year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}">更多{:str_replace('片','',$feifeilist)}综艺</a>
	</div>
	<div class="mod-main clearfix">
		<div class="mod-row">
			<ul class="m-list clearfix" m-list-skin="film">
