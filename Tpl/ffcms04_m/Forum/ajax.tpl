<php>$item_list = ff_mysql_forum('cid:'.$forum_cid.';sid:'.$forum_sid.';pid:0;status:1;limit:10;page_is:true;page_id:forum;page_p:'.$forum_page.';cache_name:default;cache_time:default;order:forum_addtime;sort:desc');
