...
<div class="container ff-bg">
  ...
  <dl class="dl-horizontal">
    <dt>频道：</dt>
    <dd class="text-nowrap type-gallery">
    ...
    <dt>类型：</dt>
    <dd class="text-nowrap type-gallery ff-text-right">
  ...
  <div class="btn-toolbar" role="toolbar">
    <div class="btn-group btn-group-sm">
      ...
      <a href="{:ff_url('vod/type',array('id'=>$type_id,'type'=>urlencode($type_type),'area'=>urlencode($type_area),'year'=>$type_year,'star'=>urlencode($type_star),'state'=>urlencode($type_state),'order'=>up,'p'=>1),true)}" class="btn btn-default" id="orderup">点赞最多</a>
    </div>
  </div>
  <div class="clearfix ff-clearfix"></div>
  <script>
