  ...
  <div class="media">
    ...
    <div class="media-body">
      ...
      <p class="forum-btn">
        ...
        <a class="btn btn-default btn-xs forum-reply-get forum-reply-get-{$feifei.forum_reply}" data-id="{$feifei.forum_id}" href="{:ff_url('forum/detail', array('id'=>$feifei['forum_id']), true)}" target="_blank" title="查看详情"><span class="glyphicon glyphicon-align-right"></span> 详情</a>
      </p>
