...
<include file="BlockSeo:forum_detail_guestbook" />
</head>
...
<div class="page-header">
  <h2>
    ...
    <a href="{:ff_url('forum/detail', array('id'=>$forum_id), true)}">留言主题</a>
  </h2>
</div>
<!-- -->
<p class="content">
...
<!-- -->
<div class="page-header">
  <h2><span class="glyphicon glyphicon-comment ff-text"></span> 发表您对此留言的看法</h2>
</div>
<!--发表评论后刷新网页 -->
