...
<div class="page-header">
  <h1 class="ff-text-hidden text-center">
    {$news_name}
  </h1>
  <h6 class="tags text-center">
    <a class="btn btn-default btn-xs" href="javascript:;">
    	<span class="glyphicon glyphicon-user"></span> {$news_inputer|default='admin'}
    </a>
    <a class="btn btn-default btn-xs" href="javascript:;">
    	<span class="glyphicon glyphicon-time"></span> {$news_addtime|date='Y-m-d',###}
    </a>
    <a class="btn btn-default btn-xs" href="javascript:;">
    	<span class="glyphicon glyphicon-fire"></span> {$news_hits+999|number_format}
    </a>
    ...
    <eq name="feifei.tag_list" value="news_type">
      ...
      <span class="glyphicon glyphicon-th-large"></span> {$feifei.tag_name|msubstr=0,4}
      </a>
    <else/>
