...
<!-- -->
<volist name=":explode(',',$list_extend['area'])" id="feifeilist" offset="0" length="6">
<php>$item_list=ff_mysql_vod('cid:'.$list_id.';area:'.$feifeilist.';limit:9;cache_name:default;cache_time:default;order:vod_stars desc,vod_addtime;sort:desc');</php>
<notempty name="item_list">
<div class="row">
  <div class="col-xs-9">
  	<div class="page-header">
      <h2>{:str_replace(array('国','台湾','大陆','香港','日本'),array('剧','台剧','国产剧','港剧','日剧'),$feifeilist)} <a class="btn btn-xs btn-default pull-right" href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>'','area'=>urlencode($feifeilist),'year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}">更多 <span class="glyphicon glyphicon-chevron-right"></span></a></h2>
    </div>
    <div class="row ff-row">
    	<div class="col-xs-4 ff-col">
      	<ul class="list-unstyled vod-item-img ff-img-310">
  ...
  <div class="col-xs-3">
  	<div class="page-header">
    	<h2>{:str_replace(array('国','台湾','大陆','香港','日本'),array('剧','台剧','国产剧','港剧','日剧'),$feifeilist)}&nbsp;•&nbsp;排行榜</h2>
    </div>
    <php>$item_list=ff_mysql_vod('cid:'.$list_id.';area:'.$feifeilist.';limit:10;cache_name:default;cache_time:default;order:vod_stars desc,vod_hits;sort:desc');</php>
    <include file="BlockTheme:vod_channel_hot" />
  </div>
</div><!--row end -->
