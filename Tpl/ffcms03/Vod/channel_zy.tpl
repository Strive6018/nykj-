...
<div class="row">
  ...
  <div class="col-xs-3">
    ...
    <php>$item_list=ff_mysql_vod('cid:'.$list_id.';tag_name:'.$feifeilist.';tag_list:vod_type;limit:10;cache_name:default;cache_time:default;order:vod_hits;sort:desc');</php>
    <include file="BlockTheme:vod_channel_hot" />
  </div>
</div><!--row end -->
