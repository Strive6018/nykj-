...
<div class="panel panel-default">
  <div class="panel-heading">
    ...
    《{$feifei.vod_name}》第<span class="ff-text">{$vod_scenario.info|count}</span>集剧情介绍
  ...
  <div class="panel-body">
    ...
    <p class="ff-text-right"><volist name="vod_scenario.info" id="scenario">
    <a href="{:ff_url('scenario/detail', array('id'=>$feifei['vod_id'],'pid'=>$i), true)}" title="{$feifei.vod_name}第{$i}集剧情介绍">第{$i}集</a>
    </volist></p>
  </div>
