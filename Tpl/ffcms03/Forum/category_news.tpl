<php>
$forum_sid = 2;
$item_list = ff_mysql_forum('cid:'.$forum_cid.';status:1;sid:2;pid:0;limit:30;page_is:true;page_id:forum;page_p:'.$forum_page.';order:forum_addtime;sort:desc');
...
<div class="page-header">
  <h2>
  	<a class="ff-text" href="{$page_this}">资讯评论</a>
    <span class="text-muted">{$news.news_name}</span>
