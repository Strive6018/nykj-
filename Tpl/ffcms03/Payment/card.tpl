        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <input class="form-control text-center" name="card_number" id="card_number" type="text" required>
				...
				<a class="btn btn-play" href="{:C('pay_card_sell')}"target="_blank">购买卡密</a>
				<button class="btn btn-play" type="submit">提交充值</button>
      </form>
    </div>
    <div class="modal-footer">
        <h5 class="alert-card text-center">
        本站卡密24小时无人自动发货，如需购买请点击<a href="{:C('pay_card_sell')}" target="_blank">这里</a>、1元等于<span class="ff-text">{:C("user_pay_scale")}</span>个影币</span>
        </h5>
    </div>
  </div>
</div>
