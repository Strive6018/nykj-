...
<body class="bg-light forum-detail-guestbook ff-forum-reload">
<include file="BlockTheme:header" />
<main class="container">
<ul class="breadcrumb mt-3 mb-0">
  <li class="breadcrumb-item"><a href="{$root}">首页</a></li>
	<li class="breadcrumb-item"><a href="{:ff_url('forum/index', array('sid'=>5), true)}">网站留言</a></li>
...
<div class="card mt-3">
  <div class="card-body">
		<div class="card-text forum-content">
			...
			@<a href="{:ff_url('forum/guestbook',array('cid'=>$forum_id),true)}">主题</a>
		</div>
