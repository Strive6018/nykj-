...
<div class="container">	
<volist name=":explode(',',$list_extend['area'])" id="feifeilist" offset="0" length="10">
...
<div class="alert bg-theme border-0 mt-3 mb-0">
	<eq name="list_id" value="2">
		<strong class="h5 text-white">{:str_replace(array('国','台湾','大陆','内地','香港','日本'),array('剧','台剧','国产剧','国产剧','港剧','日剧'),$feifeilist)}</strong>
	<else/>
		<strong class="h5 text-white">{$feifeilist}</strong>
	</eq>
	<span class="float-right">
		<a href="{:ff_url('vod/type',array('id'=>$list_id,'type'=>'','area'=>urlencode($feifeilist),'year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true)}"><i class="fa fa-chevron-right"></i></a>
	</span>
</div>
<div class="row">
