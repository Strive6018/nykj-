<?php
//$config = array('ftp_host'=>'218.6.xxx.xxx','ftp_port'=>21,'ftp_user'=>'xxx','ftp_pwd' =>'xxxxx','ftp_dir'=>'/');
//$ftp=new ftp();
//$ftp->config($config);
//$ftp->connect();
//$ftp->put(C('upfile_path').'/'.$thumb, $thumb);
//$ftp->put(C('upfile_path').'/'.$file, $file);
//@unlink($this->getPicFile($file));
//@unlink($this->getPicFile($thumb));
class ftp{
	protected $_config = array( 'ftp_host'=>'www.ffcms.cn', 'ftp_port'=>'21', 'ftp_user'=>'feifeicms', 'ftp_pwd' =>'feifeicms', 'ftp_timeout'=>'30', 'ftp_dir' =>'/', 'ftp_pasv'=>1 );
