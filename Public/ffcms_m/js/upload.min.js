(function($) {
    ...
    $.fn.imageUpload = function(options) {
        ...
        var $uploadButton = $("<button style="border: 0;background: rgba(224, 224, 224, 0);">").attr("type", "submit").addClass(settings.uploadButtonClass).html(settings.uploadButtonValue);
        var $browseButton = $("<button style="border: 0;background: rgba(224, 224, 224, 0);">").addClass(settings.browseButtonClass).html(settings.browseButtonValue).on("click", function() {
            $fileInput.click();
            return false
        });
